...
<div
	...
	class="gift-card-grid isolate grid auto-rows-fr grid-cols-2 gap-2 sm:auto-rows-auto sm:gap-5 sm:[grid-template-columns:repeat(auto-fill,minmax(280px,1fr))]"
>
